...
lint: ## Lint code (Python, JS, YAML)
	...
	@echo "Running pylint..."
	@pylint odoo/modules/ odoo/addons/ odoo/custom-addons/ scripts/ --exit-zero || echo "⚠️  pylint not installed"
	@echo "Running flake8..."
	@flake8 odoo/modules/ odoo/addons/ odoo/custom-addons/ scripts/ --exit-zero || echo "⚠️  flake8 not installed"
