...
# ── Module sets ────────────────────────────────────────────────────────────────
CORE_MODS = barcodes,hr_timesheet,contacts,mail,calendar,account,purchase,sale_management,stock,stock_barcode,hr,hr_holidays,hr_expense,timesheet_grid,project,documents
