...
| `mcp_integration` | 19.0.1.0.0 | Tools | Model Context Protocol integration for Odoo workflows |  |
| `microservices_connector` | 19.0.251027.1 | Connectors | Integration with OCR, LLM, and Agent microservices |  |
| `odoo_knowledge_agent` | 19.0.1.0.0 | Tools | Forum scraper and error prevention for Odoo custom modules |  |
...
| `slack_bridge` | 19.0.1.0.0 | Productivity | Slack integration for InsightPulse AI agencies |  |
