...
def odoo_rpc_call(
    ...
    try:
        ...
        if not uid:
            raise ValueError(f"Authentication failed for user '{username}' on database '{db}'")
...
def odoo_search_read(url: str, db: str, username: str, password: str,
                     model: str, domain: List = None, fields: List = None,
