...
def main():
    ...
    parser.add_argument('--setup', action='store_true',
                       help='Clone all OCA repositories')
    parser.add_argument('--update', action='store_true',
                       help='Update all existing repositories')
    parser.add_argument('--list', metavar='REPO',
                       help='List modules (optionally for specific repo)')
    parser.add_argument('--search', metavar='QUERY',
                       help='Search for modules by name or description')
    parser.add_argument('--catalog', action='store_true',
                       help='Generate OCA modules catalog')
    ...
    if args.setup:
        ...
        print("  python scripts/vendor_oca_enhanced.py --search accounting  # Search modules")
