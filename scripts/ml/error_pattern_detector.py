...
class ErrorPatternDetector:
    ...
    def _generate_seed_patterns(self) -> List[Dict]:
        ...
        return [
            # Dependency missing
            {"message": "ModuleNotFoundError: No module named 'pytest_cov'", "category": "dependency_missing"},
            {"message": "ImportError: cannot import name 'foo' from 'bar'", "category": "dependency_missing"},
            {"message": "ERROR: Could not find a version that satisfies the requirement", "category": "dependency_missing"},
            {"message": "pip: command not found", "category": "dependency_missing"},
            {"message": "No module named 'anthropic'", "category": "dependency_missing"},

            # Environment variable
            {"message": "KeyError: 'OCR_HOST'", "category": "environment_variable"},
            {"message": "Environment variable SUPABASE_URL not set", "category": "environment_variable"},
            {"message": "Invalid URL 'None': No host supplied", "category": "environment_variable"},
            {"message": "os.environ['DATABASE_URL'] raised KeyError", "category": "environment_variable"},
            {"message": "Missing required environment variable: API_KEY", "category": "environment_variable"},

            # API contract mismatch
            {"message": "AssertionError: assert None is True", "category": "api_contract_mismatch"},
            {"message": "KeyError: 'ok' - response={'status': 'ok'}", "category": "api_contract_mismatch"},
            {"message": "JSONDecodeError: Expecting value: line 1 column 1", "category": "api_contract_mismatch"},
            {"message": "404 Not Found - endpoint /classify/expense", "category": "api_contract_mismatch"},
            {"message": "Response missing required field: 'data'", "category": "api_contract_mismatch"},

            # Network timeout
            {"message": "requests.exceptions.ConnectionError: Connection timed out", "category": "network_timeout"},
            {"message": "TimeoutError: Read timed out after 30 seconds", "category": "network_timeout"},
            {"message": "urllib3.exceptions.MaxRetryError: Max retries exceeded", "category": "network_timeout"},
            {"message": "Connection refused on port 5432", "category": "network_timeout"},
            {"message": "DNS resolution failed for api.example.com", "category": "network_timeout"},

            # Permission denied
            {"message": "PermissionError: [Errno 13] Permission denied", "category": "permission_denied"},
            {"message": "Error: EACCES: permission denied, open '/var/log/app.log'", "category": "permission_denied"},
            {"message": "Access forbidden: insufficient permissions", "category": "permission_denied"},
            {"message": "sudo: command not found", "category": "permission_denied"},
            {"message": "GitHub Actions: Resource not accessible by integration", "category": "permission_denied"},

            # Configuration error
            {"message": "YAML parsing error: mapping values are not allowed here", "category": "configuration_error"},
            {"message": "Invalid configuration: missing required field 'database'", "category": "configuration_error"},
            {"message": "ConfigParser.NoSectionError: No section: 'database'", "category": "configuration_error"},
            {"message": "Syntax error in .github/workflows/ci.yml line 42", "category": "configuration_error"},
            {"message": "Invalid value for 'timeout': expected int, got str", "category": "configuration_error"},

            # Syntax error
            {"message": "SyntaxError: invalid syntax at line 15", "category": "syntax_error"},
            {"message": "IndentationError: unexpected indent", "category": "syntax_error"},
            {"message": "NameError: name 'variabel' is not defined", "category": "syntax_error"},
            {"message": "TypeError: unsupported operand type(s) for +", "category": "syntax_error"},
            {"message": "AttributeError: 'NoneType' object has no attribute 'get'", "category": "syntax_error"},

            # Import error
            {"message": "ImportError: attempted relative import with no known parent", "category": "import_error"},
            {"message": "ModuleNotFoundError: No module named 'addons.custom'", "category": "import_error"},
            {"message": "Circular import detected: module A imports module B", "category": "import_error"},
            {"message": "ImportError: cannot import name 'X' from partially initialized module", "category": "import_error"},
            {"message": "ImportError: DLL load failed while importing _ctypes", "category": "import_error"},
        ]
...
4. Avoid circular imports by refactoring
        ...
        return fixes.get(category, "Manual investigation required. Review error logs for details.")
