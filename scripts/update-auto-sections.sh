...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "🔄 Updating Auto-Generated Documentation Sections..."
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
...
for file in claude.md .github/PLANNING.md DOCUMENTATION_SYSTEM.md; do
    if [[ -f "$file" ]]; then
        if grep -q "Last Updated:" "$file" || grep -q "Last Auto-Updated:" "$file"; then
            ...
            echo -e "   ${GREEN}✅ Updated timestamp in $file${NC}"
        fi
    fi
done
echo ""
...
echo "2️⃣  Generating MODULE_INDEX.md..."
...
if [[ -d "odoo/addons" ]]; then
    ...
    for module in odoo/addons/*; do
        if [[ -d "$module" ]] && [[ -f "$module/__manifest__.py" ]]; then
            ...
            if [[ -f "$module/README.md" ]]; then
                ...
                MISSING+=("$MODULE_NAME")
                echo "| $MODULE_NAME | ❌ | $DESCRIPTION |" >> docs/MODULE_INDEX.md
            fi
        fi
    done
    ...
    echo -e "   ${GREEN}✅ Generated MODULE_INDEX.md ($TOTAL modules)${NC}"
else
    echo "No modules found" >> docs/MODULE_INDEX.md
    echo -e "   ${YELLOW}⚠️  odoo/addons directory not found${NC}"
fi
echo ""

# 3. Update cross-references section in README.md (if marker exists)
echo "3️⃣  Updating cross-references..."

if [[ -f "README.md" ]]; then
    # Check if README has a cross-reference section
    if ! grep -q "claude.md" README.md; then
        echo -e "   ${YELLOW}ℹ️  Add cross-reference to claude.md manually${NC}"
    else
        echo -e "   ${GREEN}✅ Cross-reference to claude.md exists${NC}"
    fi
fi

if [[ -f "claude.md" ]]; then
    if ! grep -q "README.md" claude.md; then
        echo -e "   ${YELLOW}ℹ️  Add cross-reference to README.md manually${NC}"
    else
        echo -e "   ${GREEN}✅ Cross-reference to README.md exists${NC}"
    fi
fi
echo ""

# 4. Ensure CHANGELOG.md exists
echo "4️⃣  Checking CHANGELOG.md..."
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo -e "${GREEN}✅ Auto-generated sections updated successfully${NC}"
echo ""
echo "Files modified:"
echo "  - docs/MODULE_INDEX.md"
