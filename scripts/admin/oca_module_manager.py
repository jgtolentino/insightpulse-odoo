...
class OCAModuleManager:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return {
                    ...
                    "last_commit": commit_data.get("commit", {})
                    .get("author", {})
                    .get("date"),
                }
            else:
    ...
    def install_module_stack(self, module_list: List[str], force: bool = False) -> Dict:
        ...
        try:
            ...
            _logger.error(
                "Cannot import Odoo - make sure PYTHONPATH includes Odoo directory"
            )
            return {
                "installed": [],
...
def main():
    ...
    if command == "status":
        ...
        results = manager.install_module_stack(OCAModuleManager.FINANCE_SSC_STACK)
