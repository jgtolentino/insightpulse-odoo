...
class IPAIAgentConfig(models.TransientModel):
    ...
    agent_enabled = fields.Boolean(
        ...
        default=True,
        help='Enable/disable AI agent globally'
    )
    ...
    def get_values(self):
        ...
        res.update({
            ...
            'agent_api_key': IrConfigParam.get_param('ipai_agent.api_key', default=''),
            'agent_timeout': int(IrConfigParam.get_param('ipai_agent.timeout', default='30')),
            'agent_max_retries': int(IrConfigParam.get_param('ipai_agent.max_retries', default='2')),
            'agent_enabled': IrConfigParam.get_param('ipai_agent.enabled', default='True') == 'True',
        })
        return res
