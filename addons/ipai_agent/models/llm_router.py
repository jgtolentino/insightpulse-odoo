...
class LLMRouter:
    ...
    def _load_config(self):
        ...
        return {
            ...
            "gradient_enabled": IrConfigParam.get_param(
                "ipai_agent.gradient_enabled", default="True"
            )
            == "True",
            "gradient_model": IrConfigParam.get_param(
                "ipai_agent.gradient_model", default="openai-gpt-oss-120b"
            ),
            "gradient_max_tokens": int(
                IrConfigParam.get_param("ipai_agent.gradient_max_tokens", default="500")
            ),
            # General settings
    ...
    def _get_gradient_client(self):
        ...
        try:
            ...
            self._gradient_client = Gradient(model_access_key=model_access_key)
    ...
    def _try_gradient(self, messages):
        ...
        try:
            ...
            _logger.info(
                f"Gradient API response received (model: {self._config['gradient_model']})"
            )
    ...
    def get_status(self):
        ...
        status = {
            ...
            "gradient": {
                "configured": self._config["gradient_enabled"]
                and bool(os.environ.get("MODEL_ACCESS_KEY")),
                "available": False,
            },
        }
