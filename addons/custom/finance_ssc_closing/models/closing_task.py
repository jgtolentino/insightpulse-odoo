...
class FinanceClosingTask(models.Model):
    ...
    def _compute_dependency_status(self):
        ...
        for task in self:
            ...
            task.blocked_by_count = len(task.depends_on_ids.filtered(lambda t: t.state != 'completed'))
    ...
    def action_reject(self):
        ...
        for task in self:
            ...
            task.message_post(body=_('Task rejected. Please address the review comments.'))
