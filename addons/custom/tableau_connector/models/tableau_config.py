...
class TableauConfig(models.Model):
    ...
    server_url = fields.Char(string="Tableau Server URL", required=True, default="https://tableau.example.com")
...
class TableauDashboard(models.Model):
    ...
    config_id = fields.Many2one("tableau.config", string="Tableau Configuration", required=True)
