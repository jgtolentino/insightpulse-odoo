...
class TestEmbeddedController(HttpCase):
    ...
    def test_dashboard_list_endpoint(self):
        ...
        self.assertEqual(response.status_code, 200, "Dashboard list endpoint should return 200")
        self.assertIn(b'Superset Dashboards', response.content,
    ...
    def test_embed_endpoint_requires_auth(self):
        ...
        self.assertIn(response.status_code, [302, 303], "Should redirect unauthenticated users")
    ...
    def test_embed_endpoint_with_auth(self):
        ...
        self.assertEqual(response.status_code, 200, "Embed endpoint should return 200 with auth")
